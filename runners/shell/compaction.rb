...
TESTS = [
  "RSB_RUBIES=#{RUBY_TO_TEST} RSB_FRAMEWORKS=rails RSB_NUM_RUMS=1 RSB_DURATION=#{TEST_DURATION} RSB_WARMUP=#{TEST_WARMUP} RSB_COMPACT=YES RSB_GET_FINAL_MEM=YES bundle _1.17.3_ exec runners/rvm_rubies.rb",
  "RSB_RUBIES=#{RUBY_TO_TEST} RSB_FRAMEWORKS=rails RSB_NUM_RUMS=1 RSB_DURATION=#{TEST_DURATION} RSB_WARMUP=#{TEST_WARMUP} RSB_COMPACT=NO RSB_GET_FINAL_MEM=YES bundle _1.17.3_ exec runners/rvm_rubies.rb",
]
